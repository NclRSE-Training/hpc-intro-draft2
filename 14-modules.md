...
```bash
userid@uan01:/work/ta180/ta180/userid> module avail
```
...
```bash
userid@uan01:/work/ta180/ta180/userid> module list
```
```output
...
```bash
userid@uan01:/work/ta180/ta180/userid> nano ncdump-module.sh
userid@uan01:/work/ta180/ta180/userid> cat ncdump-module.sh
```
```output
#!/bin/bash
...
```bash
userid@uan01:/work/ta180/ta180/userid>  python-module.sh
```
:::
:::
